                                    ...
                                    <div className="pt-6">
                                        <p className="flex items-center gap-1 text-[0.875rem] uppercase text-[var(--main-color)]">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="17" viewBox="0 0 16 17" fill="none">
                                                <path d="M4.83398 2.08374V15.0699" stroke="#01787A" strokeWidth="1.29861" strokeLinecap="round" strokeLinejoin="round" />
                                                <path d="M2.88672 2.40845V5.65498C2.88672 7.27825 4.83464 7.27825 4.83464 7.27825C4.83464 7.27825 6.78256 7.27825 6.78256 5.65498V2.40845" stroke="#01787A" strokeWidth="1.29861" strokeLinecap="round" strokeLinejoin="round" />
                                                <path d="M12.6265 7.60285H10.0293V4.68097C10.0293 2.08374 12.6265 2.08374 12.6265 2.08374V7.60285ZM12.6265 7.60285V15.0699" stroke="#01787A" strokeWidth="1.29861" strokeLinecap="round" strokeLinejoin="round" />
                                            </svg>
                                            Favorite Dish
                                        </p>
