...
//         .filter(
//             (post: PostWithImage) =>
//                 post.image?.img && post.image.img !== "https://www.sherpafoodtours.com/default-og.jpg" &&
...
//         .filter(
//             (group: CompletePost) =>
//                 group.posts.length > 0 && group.category !== "Uncategorized"
//         );
...
//                                 if (post.relaciones.ciudades && post.relaciones.ciudades.length > 0) {
//                                     // console.log("POST RELACIONES:", post.relaciones);
